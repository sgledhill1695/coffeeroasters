export default function Headquarters(){
    ...
    return(
        <section className="mt-[125px]">
            ...
            <h4 className="fraunces-bold text-[#83888F] text-[24px] text-center md:text-start mb-[60px]">
                Our headquarters
            </h4>

            <div className="grid grid-cols-1 md:grid-cols-3 mt-[25px] gap-y-[80px]">

                {headquarters.map(hq => (
                    <div className="col-span-1 flex flex-col items-center md:items-start">
                        {hq.map}
                        <h5 className="fraunces-bold text-[28px] text-[#333D4B] mt-[50px]">{hq.country}</h5>
                        <div className="flex flex-col text-center md:text-start mt-[30px] gap-[10px] text-[16px]">
                            <p>{hq.addressLineOne}</p>
                            <p>{hq.addressLineTwo}</p>
                            <p>{hq.postCode}</p>
                            <p>{hq.telephoneNumber}</p>
                        </div>
